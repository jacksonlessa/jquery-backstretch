...
- [npm](https://www.npmjs.com/package/owl.carousel): `npm install --save jquery.backstretch`
- [bower](http://bower.io/search/?q=owl.carousel): `bower install --save jquery.backstretch`
